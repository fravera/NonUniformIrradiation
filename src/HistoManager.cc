...
void HistoManager::Book()
{
  ...
  G4int id = analysis->CreateH1("h1.1","Tracks Energy", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);
    
  id = analysis->CreateH1("h1.2","Energy Deposition vs Filter Thickness", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);

  id = analysis->CreateH1("h1.3","Dose  vs Filter Thickness", nbins, vmin, vmax);
  analysis->SetH1Activation(id, false);
  ...
  // histos 2D
  //
  id = analysis->CreateH2("h2.1","Energy Deposition",nbins,vmin,vmax, nbins,vmin,vmax);
  analysis->SetH2Activation(id, false);

  id = analysis->CreateH2("h2.2","Dose",nbins,vmin,vmax, nbins,vmin,vmax);
  analysis->SetH2Activation(id, false);
